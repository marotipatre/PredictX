...
import { exploresports,footballLeagues  } from "@/constant";
...
const ExplorePage: React.FC = () => {
  ...
  const filteredItems = exploresports.filter((item) =>
    ...
    <section className="relative py-24 md:py-28 lg:py-30">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col">
          <h1 className="text-xl mb-5">Top Sportify</h1>
        ...
        <div className="flex flex-col mt-10">
          <h1 className="text-xl mb-5">Top Leagues</h1>
          <div className="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
